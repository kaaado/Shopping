...
class ProductController extends Controller
{
    ...
    {
        $products = Product::with('Images')->where('status', '=', 'published')->where('discount', '>', '0')->latest()->take(4)->get();
        return $products;
    }
    ...
    {
        $products = Product::with('Images')->where('status', '=', 'published')->where('rating', '=', '5')->latest()->take(5)->get();
        return $products;
    }
